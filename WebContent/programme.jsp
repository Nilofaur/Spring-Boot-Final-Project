...
#features ul li.feature-1 {
    background: url('./img/mug.jpg') no-repeat top center;
}
#features ul li.feature-2 {
    background: url('./img/goal.jpg') no-repeat top center;
}
#features ul li.feature-3 {
    background: url('./img/winter.jpg') no-repeat top center;
}

#features ul li.feature-4 {
    background: url('./img/banana.jpg') no-repeat top center;
}
